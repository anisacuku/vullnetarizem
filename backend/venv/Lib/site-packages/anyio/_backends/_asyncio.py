        ...
        try:
            ...
            try:
                if self._tasks:
                    ...
                    # anyway
                    await AsyncIO.cancel_shielded_checkpoint()
...
class WorkerThread(Thread):
    ...
    def __init__(
        ...
        self.idle_since = AsyncIO.current_time()
        self.stopping = False
...
class Lock(BaseLock):
    ...
    async def acquire(self) -> None:
        ...
        if self._owner_task is None and not self._waiters:
            await AsyncIO.checkpoint_if_cancelled()
