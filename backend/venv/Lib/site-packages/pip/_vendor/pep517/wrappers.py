...
class Pep517HookCaller(object):
    """A wrapper around a source directory to be built with a PEP 517 .
    ...
    def _supported_features(self):
        """Return the list of optional features supported by the ."""
    ...
    def build_wheel(
        ...
        In general, this will call the 'build_wheel' hook in the .
    ...
    def build_editable(
        ...
        In general, this will call the 'build_editable' hook in the .
        However, if that was previously called by
    ...
    def _call_hook(self, hook_name, kwargs):
        ...
        if sys.version_info[0] == 2:
            build_backend = self.build_.encode('ASCII')
        else:
