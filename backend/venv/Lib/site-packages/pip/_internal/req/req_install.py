...
class InstallRequirement:
    ...
    def supports_pyproject_editable(self) -> bool:
        ...
        with self.build_env:
            ...
            with self.pep517_.subprocess_runner(runner):
                return "build_editable" in self.pep517_._supported_features()
    ...
    def update_editable(self) -> None:
        ...
        vcs_.obtain(self.source_dir, url=hidden_url, verbosity=0)
