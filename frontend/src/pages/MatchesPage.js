    ...
    <div className="matches-page full-width">
      <section className="matches-banner full-width">
        <div className="matches-banner-container">
          <h1>Përshëndetje, {profileData?.name || username}!</h1>
          <p>Këto janë përputhjet që kemi gjetur bazuar në profilin tuaj.</p>
        </div>
      </section>
        ...
        <div className="matches-container">
          ...
          {loading ? (
            ...
            <div className="no-results">
              <p>Nuk ka përputhje për momentin. Ju lutemi përditësoni profilin tuaj.</p>
            </div>
          ) : (
